    ...
    <main>
        ...
        <div class="catagoris">
            ...
            <div class="div1">
                <table class="t1">
                    <div>
                        <h3 style="background-color: #eee; padding:10px;padding-left:20px">AC Repair</h3>
                    </div>
                    <?php
                    $sql = "SELECT * FROM ac_repair";
                                ...
                                <tr class="trow">
                                    ...
                                    <td><?php echo $reco['price'] ?><br>
                                        <form name="booking<?php echo $i ?>" action="booking.php" method="post">
                                            ...
                                            <input type="hidden" name="table" value="<?php echo "AC_Repair";  ?>">
